...
public class MovieLibrary {
    ...
    public void fillMovieList() {
        ...
        movieList.add(new Movie("Gladiator", r_Scott, List.of(r_Crowe, j_Deep)));
        movieList.add(new Movie("Pirates of the Caribbean", g_Verbinski, List.of(o_Reed, j_Deep)));
        movieList.add(new Movie("Pulp Fiction", q_Tarantino, List.of(j_Travolta, u_Thurman)));
        movieList.add(new Movie("Hobbit - An Unexpected Journey", r_Scott, List.of(k_Knightley, d_Jacob)));
        movieList.add(new Movie("Poranek Kojota", p_Jackson, List.of(r_Crowe, o_Bloom)));
        movieList.add(new Movie("Transformers", q_Tarantino, List.of(r_Crowe, d_Jacob)));
        movieList.add(new Movie("Top Gun", r_Scott, List.of(r_Crowe, t_Cruze)));
        movieList.add(new Movie("Desperado", r_Scott, List.of(r_Crowe, o_Bloom)));
        movieList.add(new Movie("Mission Impossible", p_Jackson, List.of(r_Crowe, t_Cruze)));
        movieList.add(new Movie("Forest Gump", g_Verbinski, List.of(o_Reed, h_Keitel)));
    }
    ...
    public void getRandomMovieInformation() {
        System.out.println(movieList.get(RandomDataProvider.getRandomMovieIndex()));
    }
}
